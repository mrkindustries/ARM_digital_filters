...
/* Define the STM32F10x hardware depending on the used evaluation board */
  ...
  #define USB_DISCONNECT                    GPIOA					//GPIOD
  #define USB_DISCONNECT_PIN                GPIO_Pin_12				//GPIO_Pin_9
  #define RCC_APB2Periph_GPIO_DISCONNECT    RCC_APB2Periph_GPIOA	//RCC_APB2Periph_GPIOD

#elif defined (USE_STM3210E_EVAL)

  #define USB_DISCONNECT                    GPIOA	//GPIOB
  #define USB_DISCONNECT_PIN                GPIO_Pin_12	//GPIO_Pin_14
  #define RCC_APB2Periph_GPIO_DISCONNECT    RCC_APB2Periph_GPIOA	//RCC_APB2Periph_GPIOB
